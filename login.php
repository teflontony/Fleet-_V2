                            ...
                            <div class="login-form">
                                ...
                                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="loginForm" class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="username" id="username" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" class="form-control" placeholder="Username">
                                    ...
                                    <br>
                                           ...
                                           <p style="color: red; font-size: 16px;"><b>
                                             Developer Email : milestm.web@gmail.com
                                             Developer Mobile No. +254727598229</b>
                                           </p>
